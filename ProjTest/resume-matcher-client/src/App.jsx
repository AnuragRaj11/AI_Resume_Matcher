...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 text-gray-900 flex flex-col items-center p-4 sm:p-8">
      ...
      <main className="w-full max-w-4xl bg-white text-gray-900 rounded-xl shadow-lg p-6 mb-8 transition-all duration-300 hover:shadow-xl">
        <MatchForm 
      ...
      {apiError && (
        <div
          className="w-full max-w-4xl p-4 bg-red-50 text-red-700 rounded-xl border border-red-200 mb-8"
          aria-live="polite"
        >
      ...
      {loading && (
        <div className="w-full max-w-4xl flex flex-col items-center my-8 space-y-4" aria-live="polite">
      ...
      {result && (
        <section className="w-full max-w-4xl animate-fade-in" aria-live="polite">
